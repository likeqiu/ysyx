...
VL_INLINE_OPT void Vysyx_25040109_top___024root___ico_sequent__TOP__0(Vysyx_25040109_top___024root* vlSelf) {
    ...
    if (((~ (IData)(vlSelf->rst)) & ((0x80000000U <= vlSelf->pc) 
                                     & (0x87ffffffU 
                                        >= vlSelf->pc)))) {
        Vysyx_25040109_top___024root____Vdpiimwrap_ysyx_25040109_top__DOT__verilog_pmem_read_TOP(vlSelf->pc, vlSelf->__Vtask_ysyx_25040109_top__DOT__ifu__DOT__verilog_pmem_read__2__data);
        vlSelf->ysyx_25040109_top__DOT__inst_ifu = vlSelf->__Vtask_ysyx_25040109_top__DOT__ifu__DOT__verilog_pmem_read__2__data;
    } else {
...
VL_INLINE_OPT void Vysyx_25040109_top___024root___nba_sequent__TOP__0(Vysyx_25040109_top___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vfunc_ysyx_25040109_top__DOT__printf_finish__1__Vfuncout;
    __Vfunc_ysyx_25040109_top__DOT__printf_finish__1__Vfuncout = 0;
    ...
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->rst))))) {
        ...
        Vysyx_25040109_top___024root____Vdpiimwrap_ysyx_25040109_top__DOT__printf_finish_TOP(vlSelf->ysyx_25040109_top__DOT__inst_ifu, __Vfunc_ysyx_25040109_top__DOT__printf_finish__1__Vfuncout);
