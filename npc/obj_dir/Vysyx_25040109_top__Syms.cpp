    ...
    , TOP{this, namep}
{
    ...
    // Setup scopes
    __Vscope_ysyx_25040109_top.configure(this, name(), "ysyx_25040109_top", "ysyx_25040109_top", -12, VerilatedScope::SCOPE_OTHER);
    // Setup export functions
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_ysyx_25040109_top.exportInsert(__Vfinal, "print_registers", (void*)(&Vysyx_25040109_top___024root____Vdpiexp_ysyx_25040109_top__DOT__print_registers_TOP));
    }
}
