...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+13,(vlSelf->SW0));
    bufp->chgBit(oldp+14,(vlSelf->SW1));
    bufp->chgBit(oldp+15,(vlSelf->SW2));
    bufp->chgBit(oldp+16,(vlSelf->SW3));
    bufp->chgBit(oldp+17,(vlSelf->SW4));
    bufp->chgBit(oldp+18,(vlSelf->SW5));
    bufp->chgBit(oldp+19,(vlSelf->SW6));
    bufp->chgBit(oldp+20,(vlSelf->SW7));
    bufp->chgBit(oldp+21,(vlSelf->SW8));
    bufp->chgBit(oldp+22,(vlSelf->SW9));
    bufp->chgBit(oldp+23,(vlSelf->LD1));
    bufp->chgBit(oldp+24,(vlSelf->LD0));
    bufp->chgCData(oldp+25,(vlSelf->Y),2);
    ...
    bufp->chgCData(oldp+30,(vlSelf->F),2);
    bufp->chgSData(oldp+31,((0x48cU | (((IData)(vlSelf->X0) 
                                        << 0xcU) | 
                                       (((IData)(vlSelf->X1) 
                                         << 8U) | (
                                                   ((IData)(vlSelf->X2) 
                                                    << 4U) 
                                                   | (IData)(vlSelf->X3)))))),16);
    bufp->chgBit(oldp+32,(((IData)(vlSelf->Y) == vlSelf->top__DOT__i0__DOT__i0__DOT__key_list
                           [3U])));
}
