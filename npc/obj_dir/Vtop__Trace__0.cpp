...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+13,(vlSelf->F),2);
    ...
    bufp->chgSData(oldp+19,((0x48cU | (((IData)(vlSelf->X0) 
                                        << 0xcU) | 
                                       (((IData)(vlSelf->X1) 
                                         << 8U) | (
                                                   ((IData)(vlSelf->X2) 
                                                    << 4U) 
                                                   | (IData)(vlSelf->X3)))))),16);
    bufp->chgBit(oldp+20,(((IData)(vlSelf->Y) == vlSelf->top__DOT__i0__DOT__i0__DOT__key_list
                           [3U])));
}
