...
VL_ATTR_COLD void Vysyx_25040109_top___024root___ctor_var_reset(Vysyx_25040109_top___024root* vlSelf) {
    ...
    vlSelf->debug_cmd = VL_RAND_RESET_I(4);
    vlSelf->debug_addr = VL_RAND_RESET_I(32);
    ...
    vlSelf->ysyx_25040109_top__DOT__step_en = VL_RAND_RESET_I(1);
    vlSelf->ysyx_25040109_top__DOT__debug_action = VL_RAND_RESET_I(4);
