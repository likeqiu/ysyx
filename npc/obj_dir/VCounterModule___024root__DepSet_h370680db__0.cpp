...
VL_INLINE_OPT void VCounterModule___024root___nba_sequent__TOP__0(VCounterModule___024root* vlSelf) {
    ...
    IData/*31:0*/ __Vdly__CounterModule__DOT__tick;
    ...
    if (vlSelf->reset) {
    ...
    } else if ((0x1f4U == vlSelf->CounterModule__DOT__tick)) {
        ...
        if ((1U & (~ ((IData)(vlSelf->io_reset) | (~ (IData)(vlSelf->io_enable)))))) {
            __Vdly__CounterModule__DOT__tick = ((IData)(1U) 
                                                + vlSelf->CounterModule__DOT__tick);
        }
        if (vlSelf->io_reset) {
            __Vdly__CounterModule__DOT__secondsReg = 0U;
            __Vdly__CounterModule__DOT__minutesReg = 0U;
