...
void nvboard_bind_all_pins(Vtop* top) {
	...
	nvboard_bind_pin( &top->ps2_date, 1, PS2_DAT);
	...
	nvboard_bind_pin( &top->seg4, 7, SEG6A, SEG6B, SEG6C, SEG6D, SEG6E, SEG6F, SEG6G);
	nvboard_bind_pin( &top->seg5, 7, SEG7A, SEG7B, SEG7C, SEG7D, SEG7E, SEG7F, SEG7G);
